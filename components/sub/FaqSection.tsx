...
const faqData: FaqItem[] = [
  {
    id: "item-1",
    question: "DeepCore 的宏伟愿景及其实现方式是什么？",
    answer:
      "为了构建 Web3 AI 代理的未来，DeepCore 正在从“AI + 链”进化到“AI-as-Chain”，基于 MCP 协议建立首个下一代 Web3 AI 代理的全栈生态系统。我们致力于重新定义 Web3 AI 代理的基础范式，并开发下一代技术，以支持可组合智能代理在创作、分发和利用方面的创新。这一愿景通过坚实的专业技术基础得以实现——完全整合 MCP 协议，确保 AI 代理的互操作性——以及一个强大的生态系统策略，培养去中心化、开源社区，以推动创新和采用。",
  },
  {
    id: "item-2",
    question: "为什么 DeepCore 是下一代 Web3 AI 代理架构的领导者？",
    answer:
      "DeepCore 因其创新性的 MCP 协议集成而领先，使 AI 代理能够实现无缝互操作性和可组合性。我们的全栈生态系统提供全面的工具，用于开发、部署和管理，培养一个协作的开源社区。",
  },
  {
    id: "item-3",
    question: "目标受众：如何加速生态系统采用？",
    answer:
      "我们针对开发 AI 代理的开发者、整合 AI 解决方案的企业和寻求强大 Web3 工具的终端用户。加速策略包括开发者资助、战略合作伙伴关系、社区建设以及展示 DeepCore 价值的资源。",
  },
  {
    id: "item-4",
    question: "为什么选择 MCP 作为 DeepCore 的核心开发框架？",
    answer:
  ...
  },
  {
    ...
    answer:
      "开发人员可以在 DeepCore 市场上创建和货币化复杂的 AI 代理。用户受益于对一系列专门用于 DeFi 分析、NFT 交易、去中心化治理参与和个性化 Web3 体验的 AI 工具的访问，从而提高效率和决策能力。",
  },
];
